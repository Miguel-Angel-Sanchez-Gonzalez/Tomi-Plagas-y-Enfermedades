      ...
      try {
        ...
        if (response.status === 200) {
          ...
          if (responseImage.status === 200) {
            ...
            console.error(
              `Error al obtener la imagen con id ${idBed}:`,
          ...
          console.log(
            "No se encontraron las recomendaciones y/o acciones para la imagen."
          );
        } else {
          console.error(
    ...
    <div>
      ...
      <div className="checkbox-container">
        ...
        <label htmlFor="myCheckbox">
          {isChecked ? "Desmarcar como tratada" : "Marcar como tratada"}
        </label>
      </div>
